...
The following are treated as violations of this Code of Conduct in this project:

* **Posting playlist URLs, provider hostnames, or credentials** in any project space.
  This endangers the project and everyone in it. See [`CONTRIBUTING.md`](CONTRIBUTING.md).
* **Soliciting or offering IPTV subscriptions, providers, or content**, in any form,
  including via direct message to other participants.
* Pressuring maintainers to add content sources, directories, or bundled playlists after
  being told these are permanent non-goals.

These result in immediate removal of the content and, in most cases, a permanent ban.
...
[private report](https://github.com/quiblo-iptv/quiblo-app/security/advisories) or by
